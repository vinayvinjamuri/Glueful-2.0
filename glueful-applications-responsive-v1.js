...
(function(){
  ...
  function install(){
    ...
    s.textContent=`
      ...
      /* =============================================================
         TABLET — keep the desktop content, but stack it cleanly.
         Sidebar/navigation remains owned by the existing responsive nav.
         ============================================================= */
      ...
      /* =============================================================
         PHONE — one-column layout with comfortable touch spacing.
         The utility rail remains available but stacks below the header.
         ============================================================= */
      @media(max-width:767px){
        ...
        body #${VIEW}>#${RAIL} .insights{display:none!important;}
        body #${VIEW}>#${RAIL} .upcoming,
        body #${VIEW}>#${RAIL} .quick{display:block!important;}
