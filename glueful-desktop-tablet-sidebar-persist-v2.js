/* Glueful — Desktop/Tablet Sidebar Persist V4
...
(function(){
  'use strict';
  if(window.__GLUEFUL_DESKTOP_TABLET_SIDEBAR_PERSIST_V4__) return;
  window.__GLUEFUL_DESKTOP_TABLET_SIDEBAR_PERSIST_V4__=true;
  const STYLE_ID='glueful-desktop-tablet-sidebar-persist-v4-style';
    ...
    s.textContent=`
      ...
      @media(min-width:768px) and (max-width:1279px){
        body:not(.glueful-apple-dashboard) #glueful-drawer{
          ...
          flex-direction:column!important;transform:none!important;background:#fff!important;
          border-right:1px solid #e7e7ea!important;box-shadow:none!important;border-radius:0!important;
          overflow-y:auto!important;overflow-x:hidden!important;padding:24px 16px!important;
        }
        body:not(.glueful-apple-dashboard) #glueful-drawer a,
        body:not(.glueful-apple-dashboard) #glueful-drawer button{box-sizing:border-box!important;}
      }
