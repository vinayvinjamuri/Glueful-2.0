 ...
 * Safe fallback: never leave the page hidden if a feature layer is slow or fails.
 */
(function(){
  'use strict';
  ...
  async function boot(){
    try{
      ...
      try{await load('./glueful-feature-loader-v1.js?v=174');}catch(error){console.warn('[Glueful] Direct feature-loader bootstrap failed:',error);}
      ...
      await waitForFinalRuntime(1500);
