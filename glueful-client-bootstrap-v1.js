...
(function(){
  ...
  async function boot(){
    try{
      ...
      try{await load('./glueful-desktop-tablet-sidebar-persist-v2.js?v=2');}catch(error){console.warn('[Glueful] Persistent sidebar layer unavailable:',error);}
      try{await load('./glueful-feature-loader-v1.js?v=167');}catch(error){console.warn('[Glueful] Direct feature-loader bootstrap failed:',error);}
