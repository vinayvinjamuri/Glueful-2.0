  ...
  async function boot(){
    try{
      if('serviceWorker' in navigator){
        try{
          await navigator.serviceWorker.register('./sw.js?v=152',{updateViaCache:'none'});
        }catch(error){
