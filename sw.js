const CACHE_NAME="glueful-cache-v34-resume-docx-export";
...
const FIXED_PDF_DOCX_EXPORT="./glueful-resume-vector-docx-export.js";
const FIXED_PDF_TYPOGRAPHY="./glueful-resume-typography-patch-v1.js";
const FIXED_PDF_ASSETS=[FIXED_PDF_BOOTSTRAP,FIXED_PDF_MODEL,FIXED_PDF_IMPORTER,FIXED_PDF_RENDERER,FIXED_PDF_UX,FIXED_PDF_CONTROLLER,FIXED_PDF_DOCX_EXPORT,FIXED_PDF_TYPOGRAPHY];
const ASSETS=["./manifest.json",RENDER_DIAGNOSTICS_SCRIPT,...FIXED_PDF_ASSETS,"./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png","./icons/icon-maskable-512.png"];
async function networkResponse(request,preloadResponse){const p=await preloadResponse;return p||fetch(request,{cache:"no-store"})}
function stripCompetingResumeRuntime(html){return html
 ...
 .replace(/window\.openJobResumeEditor\s*=\s*openJobResumeEditor\s*;/g,"window.__gluefulLegacyResumeEditorOpen = openJobResumeEditor;")
...
if(!html.includes(RENDER_DIAGNOSTICS_SCRIPT))add(RENDER_DIAGNOSTICS_SCRIPT,"20260820-11","render-diagnostics");
add(FIXED_PDF_BOOTSTRAP,"20260820-fixedpdf26","fixed-pdf-bootstrap");
add(FIXED_PDF_DOCX_EXPORT,"20260820-vector-docx-v1.2","vector-docx-export");
add(FIXED_PDF_TYPOGRAPHY,"20260820-resume-typography-v1","resume-typography");
