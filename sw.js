const CACHE_NAME="glueful-cache-v71-jobs-mobile-polish";
...
const RUNTIME=[RENDER_DIAGNOSTICS_SCRIPT,FIXED_PDF_BOOTSTRAP,FIXED_PDF_MODEL,FIXED_PDF_IMPORTER,FIXED_PDF_RENDERER,FIXED_PDF_UX,FIXED_PDF_CONTROLLER,FIXED_PDF_DOCX_EXPORT_V2,FIXED_PDF_TYPOGRAPHY,RESUME_IMPORT_GUARD,PDF_EXPORT_FIX,JOBS_AUTH,JOBS_V15,JOBS_RELEVANCE,JOBS_DIRECT_BOOTSTRAP,JOBS_RESUME_ACTION,JOBS_LOGO_PATCH,JOBS_MOBILE_CARD_POLISH,OFFICIAL_LINK_GUARD,MOBILE_UPDATE_GUARD];
...
function stripCompetingRuntime(html){return html
 ...
 .replace(/<script[^>]+src=[\"'][^\"']*glueful-jobs-discover-v10-authoritative\\.js(?:\\?[^\"']*)?[\"'][^>]*><\\/script>/gi,\"\")
 .replace(/<script[^>]+src=[\"'][^\"']*glueful-jobs-discover-v11-stable\\.js(?:\\?[^\"']*)?[\"'][^>]*><\\/script>/gi,\"\")
 .replace(/<script[^>]+src=[\"'][^\"']*glueful-jobs-discover-v12-stable\\.js(?:\\?[^\"']*)?[\"'][^>]*><\\/script>/gi,\"\")
 .replace(/<script[^>]+src=[\"'][^\"']*glueful-jobs-discover-v13-authoritative\\.js(?:\\?[^\"']*)?[\"'][^>]*><\\/script>/gi,\"\")
 .replace(/<script[^>]+src=[\"'][^\"']*glueful-jobs-discover-v14-force\\.js(?:\\?[^\"']*)?[\"'][^>]*><\\/script>/gi,\"\")
 .replace(/<script[^>]+src=[\"'][^\"']*glueful-jobs-discover-v15-authoritative\\.js(?:\\?[^\"']*)?[\"'][^>]*><\\/script>/gi,\"\")
 ...
 .replace(/<script[^>]+src=[\"'][^\"']*glueful-jobs-mobile-card-polish-v1\\.js(?:\\?[^\"']*)?[\"'][^>]*><\\/script>/gi,\"\")
