const CACHE_NAME="glueful-cache-v25-resume-fixed-page";
...
const ASSETS=["./manifest.json",AUTHORITATIVE_RESUME_SCRIPT,DOCX_FORENSICS_SCRIPT,RENDER_DIAGNOSTICS_SCRIPT,...FIXED_PDF_ASSETS,"./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png","./icons/icon-maskable-512.png"];
