const CACHE_NAME="glueful-cache-v30-resume-fixed-page";
...
const ASSETS=["./manifest.json",DOCX_FORENSICS_SCRIPT,RENDER_DIAGNOSTICS_SCRIPT,...FIXED_PDF_ASSETS,"./icons/icon-192.png","./icons/icon-512.png","./icons/icon-180.png","./icons/icon-maskable-512.png"];
...
if(!html.includes(DOCX_FORENSICS_SCRIPT))add(DOCX_FORENSICS_SCRIPT,"20260820-5","docx-forensics");
if(!html.includes(RENDER_DIAGNOSTICS_SCRIPT))add(RENDER_DIAGNOSTICS_SCRIPT,"20260820-6","render-diagnostics");
add(FIXED_PDF_BOOTSTRAP,"20260820-fixedpdf20","fixed-pdf-bootstrap");
