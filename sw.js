const CACHE_NAME="glueful-cache-v66-jobs-v16-quick-actions";
...
const JOBS_V16="./glueful-jobs-discover-v16-authoritative.js";
...
const RUNTIME=[RENDER_DIAGNOSTICS_SCRIPT,FIXED_PDF_BOOTSTRAP,FIXED_PDF_MODEL,FIXED_PDF_IMPORTER,FIXED_PDF_RENDERER,FIXED_PDF_UX,FIXED_PDF_CONTROLLER,FIXED_PDF_DOCX_EXPORT_V2,FIXED_PDF_TYPOGRAPHY,RESUME_IMPORT_GUARD,PDF_EXPORT_FIX,JOBS_AUTH,JOBS_V16,JOBS_DIRECT_BOOTSTRAP,JOBS_RESUME_ACTION,JOBS_LOGO_PATCH,OFFICIAL_LINK_GUARD];
...
function stripCompetingRuntime(html){return html
 ...
 .replace(/<script[^>]+src=["'][^"']*glueful-jobs-discover-v16-authoritative\.js(?:\?[^"']*)?["'][^>]*><\/script>/gi,"")
