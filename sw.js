const CACHE_NAME="glueful-cache-v40-jobs-discover";
...
const JOBS_DISCOVER="./glueful-jobs-discover-v1.js";
const FIXED_PDF_ASSETS=[FIXED_PDF_BOOTSTRAP,FIXED_PDF_MODEL,FIXED_PDF_IMPORTER,FIXED_PDF_RENDERER,FIXED_PDF_UX,FIXED_PDF_CONTROLLER,FIXED_PDF_DOCX_EXPORT_V2,FIXED_PDF_TYPOGRAPHY,RESUME_IMPORT_GUARD,PDF_EXPORT_FIX,JOBS_DISCOVER];
...
function stripCompetingResumeRuntime(html){return html
 ...
 .replace(/<script[^>]+src=["'][^"']*glueful-resume-vector-docx-export\.js(?:\?[^"']*)?["'][^>]*><\/script>/gi,"")
 .replace(/<script[^>]+src=["'][^"']*glueful-resume-vector-docx-export-v2\.js(?:\?[^"']*)?["'][^>]*><\/script>/gi,"")
...
add(JOBS_DISCOVER,"20260820-jobs-discover-v1","jobs-discover");
