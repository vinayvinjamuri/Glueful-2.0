/* Glueful — Applications Reference Layout V7
 * Exact desktop reference: 260px sidebar, 370px utility rail,
 * 952px Applications main column. Data/handlers untouched.
 */
(function(){
  'use strict';
  if(window.__GLUEFUL_APPLICATIONS_REFERENCE_LAYOUT_V7__)return;
  window.__GLUEFUL_APPLICATIONS_REFERENCE_LAYOUT_V7__=true;
  const STYLE_ID='glueful-applications-reference-layout-v7-style';
  function install(){
    ...
    s.textContent=`
      @media(min-width:1280px){
        ...
        body.glueful-applications-apple #view-applications > #glueful-applications-rail-v2{
          ...
          width:370px!important;max-width:370px!important;min-width:370px!important;margin:0!important;padding:0!important;
          display:flex!important;flex-direction:column!important;gap:16px!important;box-sizing:border-box!important;
          z-index:20!important;visibility:visible!important;opacity:1!important;
        }
        body.glueful-applications-apple #view-applications > #glueful-applications-rail-v2 > #glueful-applications-workspace-v1{
          position:static!important;width:100%!important;max-width:none!important;min-width:0!important;margin:0!important;
          padding:0!important;display:flex!important;flex-direction:column!important;gap:16px!important;
        ...
        body.glueful-applications-apple #view-applications > #glueful-applications-workspace-v1{
          position:absolute!important;left:12px!important;right:auto!important;top:22px!important;width:370px!important;
          max-width:370px!important;min-width:370px!important;margin:0!important;padding:0!important;display:flex!important;
          flex-direction:column!important;gap:16px!important;box-sizing:border-box!important;z-index:20!important;
        ...
        body.glueful-applications-apple #view-applications > .view-header{
          min-height:72px!important;margin:0!important;padding:0!important;display:flex!important;
          align-items:flex-start!important;justify-content:space-between!important;gap:22px!important;
        }
        ...
        body.glueful-applications-apple #view-applications > .glueful-applications-main-wide{margin-top:14px!important;}
        body.glueful-applications-apple #view-applications > .glueful-applications-main-wide + .glueful-applications-main-centered{margin-top:14px!important;}
        body.glueful-applications-apple #view-applications > .glueful-applications-main-centered + .glueful-applications-main-centered{margin-top:16px!important;}
  ...
  function sync(){
    ...
    if(!view)return;
    if(!(view.classList.contains('active')||view.style.display==='block'))return;
    document.body.classList.add('glueful-applications-apple');
    install();
  }
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',sync,{once:true});else sync();
  [100,500,1200,2200,4000].forEach(t=>setTimeout(sync,t));
