...
(function () {
  ...
  function ensureStyles() {
    ...
    s.textContent = `
      ...
      #glueful-dashboard-gmail-sync{position:static;right:auto;bottom:auto;z-index:auto;border:0;border-radius:13px;padding:0;background:linear-gradient(135deg,#7b36ff,#286dff);color:#fff;font:600 12px Inter,system-ui,sans-serif;box-shadow:0 8px 28px rgba(0,0,0,.22);cursor:pointer;display:none;width:160px;min-width:160px;max-width:160px;height:44px;min-height:44px;box-sizing:border-box;text-align:center}.ingestion-monitor-card{display:none!important}
      @media(min-width:701px){#glueful-dashboard-header-actions{display:flex!important;align-items:center!important;gap:12px!important}#glueful-dashboard-header-actions #glueful-dashboard-gmail-sync{margin:0!important;flex:0 0 160px!important;width:160px!important;min-width:160px!important;max-width:160px!important;height:44px!important;min-height:44px!important}}
