/* Glueful — Applications Reference UI V8
 * Presentation-only layer for the Applications page.
 * Keeps the workspace panels clear of the persistent desktop/tablet sidebar.
 */
(function(){
  'use strict';
  if(window.__GLUEFUL_APPLICATIONS_REFERENCE_V8__) return;
  window.__GLUEFUL_APPLICATIONS_REFERENCE_V8__=true;
  const STYLE_ID='glueful-applications-reference-v8-style';
  ...
  function install(){
    ...
    s.textContent=`
      ...
      @media(min-width:1101px){
        /* Persistent sidebar occupies the first 230px. Applications uses the
           remaining desktop canvas as a deliberate three-column workspace. */
        body #view-applications{position:relative!important;left:0!important;width:720px!important;max-width:720px!important;margin-left:570px!important;margin-right:0!important;padding:32px 0 48px!important;box-sizing:border-box!important;overflow:visible!important;height:auto!important;}
        ...
        /* Persistent sidebar means no desktop hamburger. */
        ...
        body #glueful-applications-left-v1{position:fixed!important;top:208px!important;left:250px!important;width:290px!important;display:flex!important;flex-direction:column!important;gap:16px!important;z-index:20!important;}
