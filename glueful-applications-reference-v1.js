/* Glueful — Applications Reference UI V9
 * Presentation-only layer for the Applications page.
 * Search Progress belongs at the top of the right workspace; Focus Today is removed.
 */
(function(){
  'use strict';
  if(window.__GLUEFUL_APPLICATIONS_REFERENCE_V9__) return;
  window.__GLUEFUL_APPLICATIONS_REFERENCE_V9__=true;
  const STYLE_ID='glueful-applications-reference-v9-style';
  ...
  function addWorkspace(){
    ...
    aside.innerHTML=`
      <section class="gf-insight-card gf-progress-card">
        <div class="gf-card-head"><div><h3>Search Progress</h3><p>Weekly goal</p></div><b class="gf-goal-value">5 / 10</b></div>
        <div class="gf-progress"><span></span></div>
        <p class="gf-progress-copy">Keep building momentum. Every application is another opportunity.</p>
      </section>
  ...
  function install(){
    ...
    s.textContent=`
      ...
      @media(min-width:1101px){
        body #view-applications{position:relative!important;left:0!important;width:872px!important;max-width:872px!important;margin-left:0!important;margin-right:0!important;padding:32px 0 48px!important;box-sizing:border-box!important;overflow:visible!important;height:auto!important;}
