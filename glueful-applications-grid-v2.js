...
(function(){
  ...
  function mount(){
    ...
    if(!layout){
      ...
      layout.id='glueful-applications-layout-v2';
      main=document.createElement('main');
      main.id='glueful-applications-main-v2';
      rail=document.createElement('aside');
      rail.id='glueful-applications-rail-v2';
      ...
      children.forEach(el=>{
        if(el===header || el===workspace) return;
        main.appendChild(el);
      });
      if(header) view.insertBefore(layout,header.nextSibling);
      else view.insertBefore(layout,view.firstChild);
      rail.appendChild(workspace);
    } else {
      if(workspace.parentElement!==rail) rail.appendChild(workspace);
    }
  }
  ...
  function install(){
    ...
    s.textContent=`
      ...
      @media(min-width:1280px){
        ...
        body #glueful-applications-layout-v2{
        ...
        body #glueful-applications-main-v2{
          min-width:0!important;
        ...
        body #glueful-applications-main-v2 input[type="search"],
        body #glueful-applications-main-v2 input[placeholder*="Search"],
        body #glueful-applications-main-v2 input{height:48px!important;min-height:48px!important;border:1px solid #e7e7ea!important;border-radius:12px!important;background:#fff!important;box-sizing:border-box!important;}
        body #glueful-applications-main-v2 .application-card,
        body #glueful-applications-main-v2 .job-application-card,
        body #glueful-applications-main-v2 .card{width:100%!important;min-height:88px!important;background:#fff!important;border:1px solid #e7e7ea!important;border-radius:16px!important;box-shadow:0 1px 2px rgba(0,0,0,.03),0 4px 12px rgba(0,0,0,.04)!important;box-sizing:border-box!important;}
      ...
      @media(min-width:768px) and (max-width:1279px){
        body #view-applications{position:relative!important;left:0!important;width:calc(100vw - 260px)!important;max-width:none!important;margin:0!important;padding:0 24px 40px!important;box-sizing:border-box!important;transform:none!important;overflow:visible!important;}
  ...
  function boot(){
    install();
    mount();
    [250,800].forEach(delay=>setTimeout(mount,delay));
