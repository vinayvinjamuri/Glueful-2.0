 ...
 * Matches the supplied desktop reference screenshot: persistent sidebar,
 * centered Applications content, search/filter row, application list and
 * right-side Search Progress / Application Insights / Upcoming Actions /
 * Quick Actions rail.
    ...
    s.textContent=`
      ...
      @media(min-width:1200px){
        ...
        body #view-applications .view-title{
          ...
          color:var(--gf-ref-text)!important;
          font-size:34px!important;line-height:1.08!important;
          font-weight:700!important;letter-spacing:-1px!important;
        }
        body #view-applications .view-subtitle{
          margin:0!important;color:var(--gf-ref-muted)!important;
          font-size:16px!important;line-height:1.35!important;
        }

        /* Main column and right rail align exactly like the supplied reference. */
        body #view-applications .view-header,
        body #view-applications > *:not(.view-header):not(#glueful-applications-workspace-v1){
          max-width:920px!important;
        }
        body #view-applications .view-header{width:920px!important;}
        body #view-applications > *:not(.view-header):not(#glueful-applications-workspace-v1){
          width:920px!important;box-sizing:border-box!important;
        }

        body #glueful-applications-workspace-v1{
          position:absolute!important;
          top:0!important;right:32px!important;
          width:320px!important;max-width:320px!important;
          margin:0!important;padding:0!important;
          display:flex!important;flex-direction:column!important;
          gap:16px!important;z-index:10!important;
          box-sizing:border-box!important;
        }
        body #glueful-applications-workspace-v1 > *{
          width:320px!important;max-width:320px!important;
        ...
        body #glueful-applications-workspace-v1 .gf-insight-card{
          width:320px!important;box-sizing:border-box!important;
          border-radius:18px!important;
          border:1px solid var(--gf-ref-line)!important;
          background:var(--gf-ref-card)!important;
        ...
        body #view-applications .card{
          ...
          background:#fff!important;color:var(--gf-ref-text)!important;
          border:1px solid var(--gf-ref-line)!important;
          border-radius:16px!important;
          box-shadow:0 1px 2px rgba(0,0,0,.03),0 5px 14px rgba(0,0,0,.035)!important;
          box-sizing:border-box!important;
        }
        ...
        /* Hide earlier experimental left rail so only the supplied right rail remains. */
      ...
      @media(min-width:768px) and (max-width:1199px){
        body #view-applications{
          ...
          margin:0 0 0 260px!important;padding:24px 24px 40px!important;
        ...
        body #glueful-applications-workspace-v1{
          ...
          margin-top:20px!important;display:grid!important;
      ...
      @media(max-width:767px){
        body #view-applications{
          ...
          margin:0!important;padding:16px 12px 96px!important;
          box-sizing:border-box!important;
        }
