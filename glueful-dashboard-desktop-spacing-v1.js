...
(function(){
  ...
  function install(){
    ...
    s.textContent=`
      @media(min-width:1101px){
        /* One page scroll only. The dashboard itself and its shell are not scroll containers. */
        html,body{overflow-y:auto!important;overflow-x:hidden!important;}

        /* Fixed-width reference sidebar. */
        ...
        /* Reference dashboard canvas: 40px breathing room after the 230px rail. */
        ...
        /* Keep the title/header compact and at the top of the canvas. */
        ...
        /* Add Application sits directly beside the profile control. */
        ...
        /* Five metrics form one clean reference strip. */
        ...
        body.glueful-apple-dashboard #view-dashboard .glueful-reference-stat-v1:not(:last-child){
          border-right:1px solid #e5e5ea!important;
        }
        body.glueful-apple-dashboard #view-dashboard .glueful-reference-stat-v1 .stat-label{
          margin:0!important;
          font-size:12px!important;
          line-height:1.3!important;
          font-weight:600!important;
        }
        body.glueful-apple-dashboard #view-dashboard .glueful-reference-stat-v1 .stat-value{
          margin:8px 0!important;
          font-size:30px!important;
          line-height:1.05!important;
        }
        body.glueful-apple-dashboard #view-dashboard .glueful-reference-stat-v1 .stat-meta{
          margin:0!important;
          font-size:11px!important;
          line-height:1.3!important;
        }

        /* Needs Attention + Application Pipeline. */
        ...
        body.glueful-apple-dashboard #view-dashboard #glueful-dashboard-attention-v1 .gf-company{
          font-size:12px!important;
        }
        body.glueful-apple-dashboard #view-dashboard #glueful-dashboard-attention-v1 .gf-role{
          font-size:11px!important;margin-top:3px!important;
        }
        body.glueful-apple-dashboard #view-dashboard #glueful-dashboard-attention-v1 .gf-attention-action{
        ...
        /* Recent Applications follows the reference cards with a restrained gap. */
  ...
  /* Remove nested scrolling from every ancestor of the dashboard shell. */
