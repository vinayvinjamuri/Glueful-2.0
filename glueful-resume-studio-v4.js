...
(function(){
  ...
  const css=`
    ...
    #${HUB}{font-family:Inter,system-ui,sans-serif;width:100%;max-width:none;margin:0;padding:22px 26px 52px;color:#182033;box-sizing:border-box}
