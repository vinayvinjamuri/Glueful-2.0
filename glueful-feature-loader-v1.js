 ...
 * Applications uses one clean reference presentation source plus a final
 * cleanup layer for legacy duplicate controls.
 */
(function () {
  'use strict';
  ...
  const GROUPS = {
    ...
    applications: [
      ...
      './glueful-applications-reference-v5.js?v=2',
      './glueful-applications-cleanup-v1.js?v=1'
    ],
