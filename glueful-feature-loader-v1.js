...
(function () {
  ...
  const GROUPS = {
    ...
    interviews: [
      ...
      './glueful-interviews-authoritative-v1.js?v=1'
    ],
  ...
  function initialViewForGroup(name){return {dashboard:'view-dashboard',applications:'view-applications',interviews:'view-interviews',jobs:'view-jobs',resume:'view-resume',gmail:'view-gmail'}[name]||null}
