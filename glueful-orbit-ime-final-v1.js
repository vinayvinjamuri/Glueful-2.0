...
(function(){
  ...
  function install(){
    ...
    const s=document.createElement('style');s.id=STYLE;s.textContent=`
      ...
      #${ROOT}.open .orbit5-head{flex:0 0 64px!important;height:64px!important;min-height:64px!important;position:relative!important;z-index:100!important;transform:none!important;align-self:stretch!important}
