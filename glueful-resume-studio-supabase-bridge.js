 ...
 *
 * Phase 1 runtime rule: Jobs is bootstrapped by the authoritative service-worker
 * navigation runtime. This bridge is intentionally limited to the Supabase
 * client bridge so it cannot become a second Jobs bootstrap path.
 */
(function () {
  'use strict';
  try {
