...
(function(){
  ...
  function install(){
    ...
    s.textContent=`
      ...
      @media(min-width:1280px){
        ...
        body #view-applications .view-header > a{position:static!important;top:auto!important;right:auto!important;margin:0!important;}
      ...
      @media(min-width:768px) and (max-width:1279px){
        body #view-applications{
          ...
          width:calc(100vw - 220px)!important;max-width:none!important;min-width:0!important;
          margin:0 0 0 220px!important;padding:0 24px 40px!important;
          box-sizing:border-box!important;transform:none!important;overflow:visible!important;
          display:block!important;
        }
        body #view-applications .view-header{
          position:relative!important;width:100%!important;height:72px!important;min-height:72px!important;
          margin:0 0 24px!important;padding:0!important;display:flex!important;align-items:center!important;
          justify-content:space-between!important;background:#f8f8fa!important;box-sizing:border-box!important;
        }
  ...
  function boot(){
    install();
    const observer=new MutationObserver(()=>moveWorkspaceIntoView());
